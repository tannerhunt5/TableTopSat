...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_WallRepulsionMultiplier = { UE4CodeGen_Private::EPropertyClass::Float, "WallRepulsionMultiplier", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UVRCharacterMovementComponent, WallRepulsionMultiplier), METADATA_PARAMS(Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_WallRepulsionMultiplier_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_WallRepulsionMultiplier_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_bAllowMovementMerging = { UE4CodeGen_Private::EPropertyClass::Bool, "bAllowMovementMerging", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UVRCharacterMovementComponent), &Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_bAllowMovementMerging_SetBit, METADATA_PARAMS(Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_bAllowMovementMerging_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_bAllowMovementMerging_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_bUseClientControlRotation = { UE4CodeGen_Private::EPropertyClass::Bool, "bUseClientControlRotation", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UVRCharacterMovementComponent), &Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_bUseClientControlRotation_SetBit, METADATA_PARAMS(Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_bUseClientControlRotation_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_bUseClientControlRotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_VRRootCapsule = { UE4CodeGen_Private::EPropertyClass::Object, "VRRootCapsule", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x001000000008201c, 1, nullptr, STRUCT_OFFSET(UVRCharacterMovementComponent, VRRootCapsule), Z_Construct_UClass_UVRRootComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_VRRootCapsule_MetaData, ARRAY_COUNT(Z_Construct_UClass_UVRCharacterMovementComponent_Statics::NewProp_VRRootCapsule_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UVRCharacterMovementComponent_Statics::ClassParams = {
		...
		0x00B000A4u,
		nullptr, 0,
		Z_Construct_UClass_UVRCharacterMovementComponent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_UVRCharacterMovementComponent_Statics::PropPointers),
		"Engine",
	...
	IMPLEMENT_CLASS(UVRCharacterMovementComponent, 1876054946);
