...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AVRPlayerController_Statics::NewProp_bDisableServerUpdateCamera = { UE4CodeGen_Private::EPropertyClass::Bool, "bDisableServerUpdateCamera", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(AVRPlayerController), &Z_Construct_UClass_AVRPlayerController_Statics::NewProp_bDisableServerUpdateCamera_SetBit, METADATA_PARAMS(Z_Construct_UClass_AVRPlayerController_Statics::NewProp_bDisableServerUpdateCamera_MetaData, ARRAY_COUNT(Z_Construct_UClass_AVRPlayerController_Statics::NewProp_bDisableServerUpdateCamera_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AVRPlayerController_Statics::ClassParams = {
		...
		0x009002A4u,
		nullptr, 0,
		Z_Construct_UClass_AVRPlayerController_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UClass_AVRPlayerController_Statics::PropPointers),
		"Game",
	...
	IMPLEMENT_CLASS(AVRPlayerController, 3435531179);
